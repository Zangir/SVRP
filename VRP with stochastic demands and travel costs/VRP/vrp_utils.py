...
class DataGenerator(object):
    def __init__(self, 
        ...
        args['capacity'] = int(self.test_data[::,2].mean()*F*args['n_cust']) + 1
        self.reset()
...
class Env(object):
    def __init__(self,
        ...
        self.weather = self.input_data[:,:,4:7]
